...
<x-app-layout>
    ...
    <div class="py-6">
        <form action="{{ route('questions.update', $question) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div x-data="{ fileName: '' }" class="mt-1 flex items-center gap-3">
                            ...
                            <span class="text-xs text-gray-400 dark:text-slate-500" x-show="!fileName && !'{{ $question->image }}'">Max 2MB</span>
                            ...
                            @if($question->image)
                                <a href="{{ Storage::url($question->image) }}" target="_blank" class="text-xs text-sky-600 hover:underline">
                                    <i class="fa-solid fa-paperclip mr-1"></i> Current file
                                </a>
                            @endif
                        </div>
