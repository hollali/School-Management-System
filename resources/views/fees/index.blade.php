                            ...
                            @forelse($fees as $fee)
                                <tr class="hover:bg-gray-50/50 transition @if($fee->status === 'paid' || $fee->status === 'cancelled') opacity-60 @endif">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('fees.show', $fee) }}" class="text-sky-600 hover:text-sky-800 font-medium mr-3">View</a>
                                        <a href="{{ route('fees.edit', $fee) }}" class="text-sky-600 hover:text-sky-800 font-medium mr-3">Edit</a>
