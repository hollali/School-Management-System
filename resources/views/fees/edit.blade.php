<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-white">{{ __('Edit Fee') }}</h2>
                ...
                <form action="{{ route('fees.update', $fee) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="invoice_number" value="{{ old('invoice_number', $fee->invoice_number) }}"
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="amount" value="{{ old('amount', $fee->amount) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="due_date" value="{{ old('due_date', $fee->due_date ? $fee->due_date->format('Y-m-d') : '') }}"
                                class="block w-full rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5 px-4">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="description" rows="3"
                                class="block w-full rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5 px-4">{{ old('description', $fee->description) }}</textarea>
