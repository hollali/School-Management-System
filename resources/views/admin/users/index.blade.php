                    ...
                    @foreach($users as $user)
                        <tr class="hover:bg-gray-50/50 transition">
                            ...
                            <td class="px-4 py-3 text-right">
                                @can('manage-users')
                                    <a href="{{ route('admin.users.edit', $user) }}" title="Edit" class="inline-flex items-center justify-center w-8 h-8 text-sky-600 hover:text-white hover:bg-sky-600 rounded-lg transition">
