<x-guest-layout>
    <div class="text-center mb-8">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-slate-200">Reset password</h2>
        <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">Enter your email and we'll send you a reset link</p>
    </div>

    <div class="mb-4 text-sm text-gray-600 dark:text-slate-300 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
