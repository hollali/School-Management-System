                            ...
                            @forelse($receipts as $receipt)
                                <tr class="hover:bg-gray-50/50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('receipts.show', $receipt) }}" class="text-sky-600 hover:text-sky-800 font-medium mr-3">View</a>
                                        <a href="{{ route('receipts.edit', $receipt) }}" class="text-sky-600 hover:text-sky-800 font-medium mr-3">Edit</a>
