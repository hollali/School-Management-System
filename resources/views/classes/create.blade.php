<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-white">{{ __('New Class') }}</h2>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" placeholder="Class name" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5" required>
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="grade_level" value="{{ old('grade_level') }}" placeholder="e.g. Grade 10" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="section" value="{{ old('section') }}" placeholder="e.g. Section A" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5">
                                </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="capacity" value="{{ old('capacity') }}" placeholder="Max students" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5">
                                </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="academic_year" value="{{ old('academic_year') }}" placeholder="e.g. 2024-2025" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5">
                            </div>
