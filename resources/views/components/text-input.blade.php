...
@if($toggle && $isPassword)
    <div class="relative">
        <input @disabled($disabled) {{ $attributes->merge(['class' => 'border-gray-300 dark:border-slate-600 dark:text-slate-200 dark:bg-slate-700 pr-10 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm']) }}>
...
@else
    <input @disabled($disabled) {{ $attributes->merge(['class' => 'border-gray-300 dark:border-slate-600 dark:text-slate-200 dark:bg-slate-700 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm']) }}>
@endif
