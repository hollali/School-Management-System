<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-white">{{ __('New Student') }}</h2>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Student name" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}" placeholder="student@example.com" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5" required>
                                </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="password" name="password" placeholder="Min. 8 characters" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="password" name="password_confirmation" placeholder="Repeat password" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="admission_number" value="{{ old('admission_number') }}" placeholder="e.g. ADM-2024-001" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="date" name="date_of_birth" value="{{ old('date_of_birth') }}" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5">
                                </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="phone" value="{{ old('phone') }}" placeholder="+1 (555) 000-0000" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5">
                                </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="address" rows="3" placeholder="Full address" class="block w-full pl-10 rounded-xl border-gray-200 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5">{{ old('address') }}</textarea>
                            </div>
