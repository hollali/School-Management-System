<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-bold text-gray-900 dark:text-slate-200">Add Holiday</h2>
                <p class="text-sm text-gray-500 dark:text-slate-400 mt-0.5">Define a non-attendance day</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <select name="type" required
                                ...
                                <option value="school" {{ old('type') === 'school' ? 'selected' : '' }}>School Holiday</option>
                                <option value="exam" {{ old('type') === 'exam' ? 'selected' : '' }}>Exam Day</option>
                            </select>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3"
                                      class="block w-full rounded-xl border-gray-200 dark:border-slate-600 dark:text-slate-200 dark:bg-slate-700 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm py-2.5 px-4 bg-white"
                                      placeholder="e.g. National celebration">{{ old('description') }}</textarea>
