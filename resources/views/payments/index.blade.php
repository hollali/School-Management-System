                            ...
                            @forelse($payments as $payment)
                                <tr class="hover:bg-gray-50/50 transition @if($payment->status === 'completed') opacity-60 @endif">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('payments.show', $payment) }}" class="text-sky-600 hover:text-sky-800 font-medium mr-3">View</a>
                                        <a href="{{ route('payments.edit', $payment) }}" class="text-sky-600 hover:text-sky-800 font-medium mr-3">Edit</a>
